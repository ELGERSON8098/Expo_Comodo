...
document.querySelector('title').textContent = 'Material';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    MAIN_TITLE.textContent = 'Gestionar materiales';
        ...
        DATA.dataset.forEach(row => {
            ...
            TABLE_BODY.innerHTML += `
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-info rounded me-2 mb-2 mb-sm-2" onclick="openUpdate(${row.id_material})">
                            <i class="bi bi-pencil-fill"></i>
                        </button>
                        <button type="button" class="btn btn-danger rounded me-2 mb-2 mb-sm-2" onclick="openDelete(${row.id_material})">
...
const openCreate = () => {
    ...
    SAVE_MODAL.show();
    MODAL_TITLE.textContent = 'Agregar un nuevo material';
