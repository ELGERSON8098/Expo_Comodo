                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-danger  me-2 mb-2 mb-sm-2" onclick="openDelete(${row.id_talla})">
                         ...
                         <button type="button" class="btn btn-warning me-2 mb-2 mb-sm-2" onclick="openReport(${row.id_talla})">
...
const openReport = (id) => {
    ...
    const PATH = new URL(`${SERVER_URL}reports/admin/talla.php`);
    // Se agrega un parámetro a la ruta con el valor del registro seleccionado.
    PATH.searchParams.append('idTalla', id);
